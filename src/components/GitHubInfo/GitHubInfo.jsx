...
function GitHubInfo({ isDarkMode }) {
  ...
  const githubAPIBaseURL = process.env.REACT_APP_GITHUB_API_BASE_URL;
  ...
  useEffect(() => {
    if (!githubAPIBaseURL) {
      console.error(
        "GitHub API Base URL is not set. Please set it in .env file."
      );
      return;
    }
    if (searchValue !== "") {
      setLoading(true);
      axios
        .get(`${githubAPIBaseURL}/users/${searchValue}`)
        .then((response) => {
            ...
            <>
              {notFound ? (
                ...
                <>
                  ...
                  <More>
                    <LBWrapper>
                      <Location isDarkMode={isDarkMode} location={location}>
                        <LocationSVG />
                    ...
                    <TCWrapper>
                      ...
                      <Company isDarkMode={isDarkMode} company={company}>
                        <CompanySVG />
